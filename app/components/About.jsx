    ...
    >
      ...
      className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
        ...
        className='flex-1'>
            ...
            >As a fresh graduate from Pancasila University, I am passionate about exploring opportunities in UI/UX design and front-end development. 
            I have honed my skills through academic projects and personal initiatives, focusing on creating clean, user-friendly designs that solve real problems. 
            I am eager to bring my enthusiasm and fresh perspective to a team where I can grow, contribute, and help craft engaging digital experiences.
            </p>
            ...
            className='grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl'>
                ...
                index)=>(
                    ...
                    rounded-xl p-6 cursor-pointer hover:bg-sky-50
