  ...
  return (
    ...
    id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      className='text-center text-5xl font-Ovo'>
        ...
        {workData.map((project, index)=>(
            ...
            style={{backgroundImage: `url(${project.bgImage})`}}>
                ...
                group-hover:bottom-8'>
                    ...
                    flex items-center justify-center shadow-[2px_2px_0_#000] group-hover:bg-gray-100
                    transition'>
                        <Image src={assets.arrow_icon} alt="send icon" className="w-2" />
                    </div>
                    </a>
                </div>
            </motion.div>
       ...
       py-3 px-10 mx-auto my-20 hover:bg-sky-50 duration-500 
